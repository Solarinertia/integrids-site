...
function QuoteForm() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      await submitEnquiry("Package Enquiry", {
        fullName: name,
        company,
        email,
        phone,
      ...
      setSubmitError(error instanceof Error ? error.message : "We could not send your package enquiry right now. Please try again.");
    } finally {
      setSubmitting(false);
    }
  }
  ...
  return (
    <form className={styles.quoteForm} onSubmit={handleSubmit} noValidate>
      ...
      <button type="submit" className={styles.quoteSubmit} disabled={!canSubmit || submitting}>
