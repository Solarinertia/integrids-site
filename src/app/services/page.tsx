      ...
      <section className={`${styles.wrap} reveal`}>
        ...
        <div className={styles.groups}>
          {serviceGroups.map((group) => (
            <section className={`${styles.group} reveal`} key={group.title} id={group.title === "Cleaning Services" ? "cleaning-services" : group.title === "Inspection Services" ? "inspection-services" : group.title === "Performance & Support Services" ? "performance-support-services" : undefined}>
